...
class BASE(object):
    ...
    def __init__(self, device, log_file, args):
        ...
        self.args = args
        self.eps = 1e-15
        self.loss_weights = [1.0,1.0,1.0].copy()#args.loss_weights.copy()
        self.temp = 15# args.temp
...
class TIM_GD(BASE):
    ...
    def __init__(self, device, log_file, args):
        ...
        self.lr = float(1e-4)#args.lr_tim)
...
class ALPHA_TIM(BASE):
    ...
    def __init__(self, device, log_file, args):
        super().__init__(device=device, log_file=log_file, args=args)
        self.lr = float(1e-4)#args.lr_alpha_tim)
        self.entropies = ['Shannon', 'Alpha', 'Alpha'].copy() #args.entropies.copy()
        self.alpha_value = 7 #args.alpha_value
