...
def clean_voxmovies():
    voxmovies_pkl = 'saved_embs/cnceleb1_3s/manifest_cnceleb1_3s_ecapa_embs.pkl'#"saved_embs/voxceleb1_3s/voxceleb1_3s_query_ecapa_embs.pkl"
    voxmovies_dict = np.load(voxmovies_pkl, allow_pickle=True)
    ...
    save_pickle('datasets_splits/embeddings/cnceleb1_3s_ecapa_embs.pkl',new_dict)
